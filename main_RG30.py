...
numberOfSimulationRunsToGenerateData =3000
...
absolutePathProjects = relativePath + "/RG30/Set 1/"
...
# wb = Workbook()
# ws = wb.create_sheet('RG30_s1_duration',0)
#
# #combine rows
...
#
# wb.save(relativePath + "/database_900/tflearn_10.xlsx")
